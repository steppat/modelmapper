	...
	public void testMapperCreatesDtoFromDeepObjectGraph() {
		...
		mapper.addMappings(new PropertyMap<Pedido, PedidoDto>() {
			...
			protected void configure() {
				map().setPrimeroNomeCliente(source.getCliente().getNome().getPrimeiroNome());
			}
		});
		...
		Assert.assertEquals(pedido.getCliente().getNome().getPrimeiroNome(), dto.getPrimeroNomeCliente());
	}
